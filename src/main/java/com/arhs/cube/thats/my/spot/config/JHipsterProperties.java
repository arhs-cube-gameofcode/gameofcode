...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "ThatsMySpot@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "ThatsMySpot API";

        private String description = "ThatsMySpot API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "ThatsMySpot";
